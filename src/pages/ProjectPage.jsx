            ...
            {project.externalLink && (
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-lime text-black text-xs sm:text-sm font-black uppercase tracking-widest hover:bg-white hover:scale-105 transition-all shadow-[0_0_20px_rgba(196,239,71,0.3)]"
                >
                  Visit Live Website
