          ...
          <div className="relative z-10 flex flex-wrap items-start justify-between gap-6">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 text-brand-lime text-[10px] sm:text-xs font-bold uppercase tracking-[0.26em] mb-5">
                <Sparkles size={14} /> Website Design & Development
              </div>
              ...
              <p className="mt-5 text-sm sm:text-base lg:text-lg text-brand-smoke/90 leading-relaxed max-w-4xl">
                We build high-performing, mobile-first websites that don’t just look premium but actually convert.
                Your site becomes your brand’s home, your sales engine, and your credibility badge. Every layout,
                interaction, and line of code is crafted to make users stay longer, explore deeper, and take action.
              </p>
            </div>
        ...
        <div className="grid lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white leading-tight">
              Fast, flexible, and conversion-focused web experiences.
            </h2>
            <p className="mt-4 text-sm sm:text-base text-brand-smoke leading-relaxed">
              We design and develop websites that support your business goals, strengthen trust, and create a smooth
              path from first visit to final action.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
              {webServices.map((service) => (
                ...
                >
                  <LayoutTemplate size={18} className="text-brand-lime shrink-0" />
